...
public class AgendamentoController {
	...
	// busca os horarios livres
	//PreAuthorize = quais perfis terá permissão de usar o controller
	@PreAuthorize("hasAnyAuthority('PACIENTE', 'MEDICO')")
	...
	public ResponseEntity<?> historicoAgendamentosPorPaciente(HttpServletRequest request, 
		...
		//getAuthorities => possui a lista de perfis referente ao usuário logado
		//Aqui, procuramos o perfil de paciente. Dentro do SimpleGrantedAuthority, procuramos o perfil de paciente
