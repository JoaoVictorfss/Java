...
public class EmailService {
	...
	//enviaremos e-mail para confirmação
	@Autowired
	private JavaMailSender mailSender;// para fazer o envio do e-mail
	
	@Autowired
	private SpringTemplateEngine template;//para se comunicar como o template(aqui a página html)

	//e-mail para confirmação de cadastro
